...
The server SHALL publish messages to named **topics**. Producers (webhook ingestion, orchestrator, operators) MUST publish to a topic without knowing which clients are subscribed, and the set of subscribers MAY change at any time.
